                                    ...
                                    <div class="row">
                                        ...
                                        if(isset($_SESSION['tipoUsuario'])){
                                            if($_SESSION['tipoUsuario'] == 1){
                                                ...
                                                <a href="formProducto.php" class="btn btn-primary btn-fill btn-round ">Agregar producto</a>
                                    ...
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($productos as $producto) {
                                                ...
                                                //echo "EL valor de existe 2 es: ".$existe2;
                                            ?>
                                              ...
                                              <tr>
                                                ...
                                                if(isset($_SESSION['tipoUsuario'])){
                                                    if($_SESSION['tipoUsuario'] == 1){
                                                        ...
                                                        <td><a href="formProducto.php?id=<?=$producto->getId()?>" class="btn btn-warning btn-round btn-fill"> Editar</a></td>
                                                        <td>
                                                            <?php if($existe != true && $existe2 != true) {?>
                                                                <a href="eliminarProducto.php?id=<?=$producto->getId()?>" class="btn btn-danger btn-round btn-fill"> Eliminar</a>
                                                        <?php } ?>
                                                        </td>
